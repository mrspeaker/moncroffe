...
for(var i = 1; i <= 16; i <<= 1) {
	...
	GreedyTestData[i + 'x' + i + 'x' + i] = makeVoxels(
		[0,0,0],
		[i,i,i],
...
GreedyTestData['Clover'] = makeVoxels([0,0,0], [17,17,1], function(i,j,k) {
...
GreedyTestData['Hill'] = makeVoxels([-16, 0, -16], [16,16,16], function(i,j,k) {
